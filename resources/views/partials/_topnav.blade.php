...
<div class="container-fluid">
    <div class="d-flex">
        <a class="header-brand" href="{{ url('/dashboard') }}">
            <img src="{{asset('assets/images/brand/logo.png')}}" class="header-brand-img" alt="Spain logo">
        </a>
                ...
                --}}{{--<li class="">
                    <div class="dropdown d-none d-md-flex">
                        <a href="#" class="d-flex nav-link pr-0 mt-3 country-flag1" data-toggle="dropdown">
                            <span><img src="{{asset('assets/images/us_flag.jpg')}}" alt="img" class="avatar country-Flag mr-2 align-self-center"></span>
                            <div>
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow ">
                    ...
                    <a class="dropdown-item" href="{{ route('logout') }}"
                       onclick="event.preventDefault();
                        ...
                        <i class="dropdown-icon mdi  mdi-logout-variant"></i> {{ __('გამოსვლა') }}
                    </a>
